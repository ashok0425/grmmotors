                    ...
                    <div class="col-md-3 col-4">
                     ...
                     <div class="col-md-7 col-8" >
                        ...
                        <div >
                          ...
                          <img id="" src='{{asset($product->image) }}' data-zoom-image="{{asset($product->image) }}"  class="main_image img-fluid" />
...
{{--
                  ...
                  @if ($product->shop_id!==null) Shop : <a href="{{route('shop',['id'=>$product->shop_id,'name'=>$product->name])}}" > {{ $shop }} </a>| <a href="{{route('shop.add.favourite',['id'=>$product->shop_id])}}" class="promo" >Add to favourite</a>
          ...
          @endif>-</button>
                ...
                <div class="sv-product-info-checkout d-flex align-items-center">
                  ...
                  <input type="submit" name="submit" value="Buy Now">
                                     ...
                                     <a class="heart" href="{{ route('addtowishlist',['id'=>$product->id]) }}"><i class="far fa-heart shadow p-2 pt-1"></i></a>
...
<div class="container-fluid">
 ...
 <section  class="padding-bottom-sm mt-5">
  @php
      $products=DB::table('products')->where('category_id',$product->category_id)->where('status',1)->limit(6)->get();
  @endphp
      <header class="section-heading heading-line">
          <h4 class="title-section text-uppercase">Related Product</h4>
      </header>
